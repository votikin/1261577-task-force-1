...
<section class="my-list">
    <div class="my-list__wrapper">
        ...
        <div class="new-task__card">
            ...
            <div class="task-status <?= $item['status']['translation']; ?>-status"><?= $item['status']['name']; ?></div>
            <p class="new-task_description"><?= $item['description']; ?></p>
            <?php if($item['executor']['id'] != null): ?>
                <?php $userUrl = Url::to(['users/view', 'id' => $item['executor']['id']]); ?>
