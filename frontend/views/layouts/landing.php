        ...
        <div class="main-container page-header__container page-header__container--index">
            ...
            <div class="header__account--index">
                <a href="#" class="header__account-enter open-modal" data-for="enter-form">
                    <span>Вход</span></a>
                или
                <a href="<?= $signupUrl; ?>" class="header__account-registration">
                    Регистрация
                </a>
            </div>
        </div>
    ...
    <main>
        <div class="landing-container">
            <div class="landing-top">
                ...
                <button class="button" onclick='window.location.href = "<?= $signupUrl; ?>"'>Создать аккаунт</button>
            </div>
